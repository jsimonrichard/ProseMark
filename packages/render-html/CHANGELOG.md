...
- 8cafd10: Make it possible to arrow down/up into hidden content
- 8cafd10: Make it possible to view images while editing the image link (and support block-layout images)
